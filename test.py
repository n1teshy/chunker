...
def recursive_semantic_chunking_multi(
    passage, query, start_candidates=3, threshold=0.25, min_tokens=30, tolerance=0.01
):
    ...
    for idx, (chunk, score) in enumerate(survivors, start=1):
        ...
        while candidates:
            ...
            print(
                f"  Iter {iteration}: score={best_score:.3f}, tokens={len(best_chunk.split())}"
            )
